...
namespace Monaco.Editor
{
    ...
    public sealed class StandaloneEditorConstructionOptions : IStandaloneEditorConstructionOptions, IJsonable, INotifyPropertyChanged
    {
        ...
        public StandaloneEditorConstructionOptions()
        {
            AcceptSuggestionOnCommitCharacter = true;
            AcceptSuggestionOnEnter = Editor.AcceptSuggestionOnEnter.On;
            AccessibilitySupport = Editor.AccessibilitySupport.Auto;
            AutoClosingBrackets = Editor.AutoClosingBrackets.LanguageDefined;
            AutoClosingQuotes = Editor.AutoClosingQuotes.LanguageDefined;
            AutoIndent = Editor.AutoIndent.None;
            AutomaticLayout = false;
            AutoSurround = Editor.AutoSurround.Brackets;
            CodeLens = true;
            Contextmenu = true;
            CursorBlinking = Editor.CursorBlinking.Blink;
            CursorSmoothCaretAnimation = false;
            CursorStyle = Editor.CursorStyle.Line;
            CursorSurroundingLines = 0;
            CursorSurroundingLinesStyle = Editor.CursorSurroundingLinesStyle.Default;
            ...
            Folding = true;
            FoldingStrategy = Editor.FoldingStrategy.Auto;
            FontLigatures = false;
            FormatOnPaste = false;
            FormatOnType = false;
            GlyphMargin = true;
            ...
            LineNumbers = LineNumbersType.On;
            LineNumbersMinChars = 5;
            Links = true;
            MatchBrackets = Editor.MatchBrackets.Always;
            MouseStyle = Editor.MouseStyle.Text;
            MouseWheelScrollSensitivity = 1;
            MouseWheelZoom = false;
            MultiCursorMergeOverlapping = true;
            MultiCursorModifier = Editor.MultiCursorModifier.Alt;
            MultiCursorPaste = Editor.MultiCursorPaste.Spread;
            ...
            RenderLineHighlight = Editor.RenderLineHighlight.All;
            RenderWhitespace = Editor.RenderWhitespace.None;
            RevealHorizontalRightPadding = 30;
            RoundedSelection = true;
            Rulers = Array.Empty<int>();
            ScrollBeyondLastColumn = 5;
            ScrollBeyondLastLine = true;
            SelectionClipboard = true;
            SelectionHighlight = true;
            SelectOnLineNumbers = true;
            ShowFoldingControls = Show.Mouseover;
            SmoothScrolling = false;
            SnippetSuggestions = Editor.SnippetSuggestions.Inline;
            StopRenderingLineAfter = 10000;
            SuggestOnTriggerCharacters = true;
            TabCompletion = Editor.TabCompletion.On;
            WordSeparators = @"`~!@#$%^&*()-=+[{]}\|;:'"",.<>/?";
            WordWrap = Editor.WordWrap.Off;
            WordWrapBreakAfterCharacters = " \t})]?|&,;";
            WordWrapBreakBeforeCharacters = "{([+";
            WordWrapBreakObtrusiveCharacters = ".";
            WordWrapColumn = 80;
            WordWrapMinified = true;
            WrappingIndent = Editor.WrappingIndent.None;
